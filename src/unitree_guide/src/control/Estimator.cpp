/*
* 状态估计器，使用卡尔曼滤波器来融合IMU和脚部传感器的数据，估计出机身的状态，包括位置、速度、姿态等信息
* 状态 x_hat_ 是 18 维：机身位置 3 + 机身速度 3 + 四只脚的位置 12
* 观测 y_ 是 28 维：四脚相对机身位置 12 + 四脚速度 12 + 四脚高度 4
*/
