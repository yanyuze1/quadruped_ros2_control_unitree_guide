/**********************************************************************
+ 数学工具
+  - 定义了一些常用的数学工具函数，如求最大值、最小值、饱和函数、去零偏函数、窗口函数等。
+  - 提供了更新平均值和协方差的函数，方便在数据处理过程中进行统计分析。
+  - 包含了一些常用的旋转矩阵和齐次矩阵的函数，如绕x轴、y轴、z轴的旋转矩阵，旋转矩阵与指数坐标的转换函数，齐次矩阵的构造和求逆函数等。
+  - 该文件是整个项目中数学计算的基础，其他模块可以直接使用这些定义的函数，简化代码编写，提高代码的可读性和维护性。
***********************************************************************/
#ifndef MATHTOOLS_H
#define MATHTOOLS_H
